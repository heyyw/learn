...
public class CaseRunner4_2 {
  ...
  private static Runnable createTask(InputStream in, int sampleInterval,
    ...
    taskClazz = null == taskClazz ? "statistic.MultithreadedStatTask"
        : taskClazz;

//    taskClazz = null == taskClazz ? "statistic.SimpleStatTask"
//            : taskClazz;
  ...
  private static InputStream createInputStream() {
    ...
    InputStream dataIn = CaseRunner4_2.class
        .getResourceAsStream("/statistic/in.dat");
    ...
    SequenceInputStream si = new SequenceInputStream(
        new Enumeration<InputStream>() {
          ...
          public InputStream nextElement() {
            ...
            if (null != fileName) {
              try {
                in = CaseRunner4_2.class.getResourceAsStream("/statistic/InputFiles/"
                    + fileName);
              } catch (Exception e) {
                e.printStackTrace();
              }
