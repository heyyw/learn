...
public class RecordProcessor implements StatProcessor {
  ...
  private static final int INDEX_TIMESTAMP = 0;    //时间戳
  private static final int INDEX_TRACE_ID = 7;     //traceid
  private static final int INDEX_MESSAGE_TYPE = 2; //协议类型
  private static final int INDEX_OPERATION_NAME = 4; //接口名称
  private static final int SRC_DEVICE = 5;           //源设备名称
  private static final int DEST_DEVICE = 6;          //目标设备名称
